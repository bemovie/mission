...
//	String name;
	...
	// game method가 main method에서 사용하려면, static이 되어야 하고
	// 아니면 game class를 생성하여 객체로 받아 사용해야 한다
	// field(전역변수)를 this로 받는것은 static일 경우 불가능하다
	// ~ 결론 ~ 
	//game class를 따로 생성하여, field를 생성하고 this로 받고, main method에서 game 객체를 받는다
